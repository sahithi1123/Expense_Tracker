function About() {
  return (
    ...
    <p>Smart Expense Tracker is a user-friendly web application designed to help individuals manage their 
        ...
        daily expenses, categorize them under predefined sections such as Food, Rent, Utilities, and more,
        and set monthly budgets based on their income. The application provides a visually appealing
        dashboard where users can monitor their spending habits through charts and graphs, making it
        easier to understand where their money is going. With features like real-time feedback and budget 
