    ...
    <>
      ...
      <div className="dashboard-container">
        ...
        <div className="dashboard-sidebar">
          ...
          <Link to='/oinsights'><button>🤖 Overall Insights</button></Link>
          <Link to='/minsights'><button>📅 Monthly Insights</button></Link>
        </div>
      </div>
      ...
      <div 
        className="ai-button"
        onClick={() => window.location.href="/chat"}   // OR open popup later
      >
        🤖
      </div> */}
    </>
